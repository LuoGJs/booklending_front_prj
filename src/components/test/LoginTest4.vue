  ...
  export default {
    ...
    methods: {
      ...
      doLogin() {
        ...
        //http://16.23.192.58:8888/moocdemo

        let url = 'http://localhost:8888/moocdemo/users/login?token=' + this.token;
        console.log(url);
        let that = this;
        this.axios.get(url, {
          params: {
      ...
      doLogin2() {
        ...
        let url = 'http://localhost:8888/moocdemo/users/login2?token=' + this.token;
        console.log(url);
        let that = this;
      ...
      changeRandomCode: function () {
        ...
        this.randomCodeUrl = 'http://localhost:8888/moocdemo/commons/mathRandomCode?token=' + this.token
      }
    },
